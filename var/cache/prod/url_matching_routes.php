...
return [
    false, // $matchHost
    [ // $staticRoutes
        '/import' => [[['_route' => 'app_import', '_controller' => 'App\\Controller\\ImportController::getJokes'], null, null, null, false, false, null]],
    ...
    [ // $dynamicRoutes
        ...
        136 => [[['_route' => 'app_rate_joke', '_controller' => 'App\\Controller\\RateJokeController::index'], ['id'], null, null, false, true, null]],
        163 => [
            [['_route' => 'app_view_joke', '_controller' => 'App\\Controller\\ViewJokeController::index'], ['id'], null, null, false, true, null],
